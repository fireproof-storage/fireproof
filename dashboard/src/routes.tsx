...
import DatabasesNew, {
  Action as newDatabaseAction,
} from "./pages/databases/new";
...
const router = import.meta.env.VITE_CHROME_EXTENSION
  ? createMemoryRouter(routes)
  : createBrowserRouter(routes);

const rootElement = import.meta.env.VITE_CHROME_EXTENSION
  ? document
      .getElementById("fireproof-overlay")
