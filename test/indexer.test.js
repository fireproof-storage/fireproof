...
describe('indexer', () => {
  it('with a store with one value', async () => {
    const blocks = new Blockstore()
    const alice = new TestPail(blocks, [])
    const key = 'key'

    // store a block of dag-cbor data to the Blockstore and get the cid
  ...
  it('with a store with multiple values', async () => {
    const blocks = new Blockstore()
    const alice = new TestPail(blocks, [])
  ...
  it('two indexes two different stores, same cid', async () => {
    const blocks = new Blockstore()
    const alice = new TestPail(blocks, [])
