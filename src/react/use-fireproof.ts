import type { Attachable, ConfigOpts, Database } from "@fireproof/core";
import { Attached, fireproof } from "@fireproof/core";
...
export function useFireproof(name: string | Database = "useFireproof", config: UseFPConfig = {}): UseFireproof {
  ...
  return { database, useLiveQuery, useDocument, useAllDocs, useChanges, attached };
}
