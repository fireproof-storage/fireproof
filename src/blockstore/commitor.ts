...
import { AnyBlock, AnyLink, CarGroup, CarHeader, CarLog, CarMakeable, CommitOpts, DataStore, DbMeta, MetaStore, toCIDBlock, TransactionMeta, WALStore } from "./types";
...
export async function commit<T>(params: CommitParams,
    t: CarTransaction,
    done: T,
    opts: CommitOpts = { noLoader: false, compact: false }): Promise<{ cgrp: CarGroup, header: CarHeader<T>}> {
