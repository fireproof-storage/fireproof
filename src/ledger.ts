...
import { type DocUpdate, type ConfigOpts, type DocWithId, type ListenerFn, type DocTypes, type SuperThis, PARAM } from "./types.js";
...
import { type Database, DatabaseImpl } from "./database.js";
...
export interface Ledger extends HasCRDT<DocTypes> {
  // readonly name: string;
...
export function fireproofDB(name: string, opts?: ConfigOpts): Database {
  return fireproof(name, opts).asDB();
}
