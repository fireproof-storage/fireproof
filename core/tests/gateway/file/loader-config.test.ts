...
describe("config file gateway", () => {
  ...
  it("loader", async () => {
    ...
    const fileStore = db.ledger.crdt.blockstore.loader.attachedStores.local().active.file;
    ...
    const dataStore = db.ledger.crdt.blockstore.loader.attachedStores.local().active.car;
